...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='C:/Users/iipl/Desktop/correct_baselines/kgec_kowiki_')
    ...
    if args.test:
        train_data, valid_data, test_data = train_data[:60], valid_data[:60], test_data[:60]
